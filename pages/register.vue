        ...
        <div class="w-full md:w-1/2 flex flex-col">
            ...
            <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                ...
                <form class="flex flex-col pt-3 md:pt-8" onsubmit="event.preventDefault();">
                    ...
                    <input type="submit" value="Register" class="bg-black text-white font-bold text-lg hover:bg-indigo-700 duration-300 cursor-pointer p-2 mt-8">
                </form>
                <div class="text-center pt-12 pb-12">
                    <p>Already have an account? <NuxtLink to="/login" class="font-semibold text-gray-700 hover:text-indigo-600 dark:text-gray-300 dark:hover:text-indigo-400 duration-300">Log in here.</NuxtLink></p>
                </div>
            </div>
